...
#         'NAME': 'video_confirence',
#         'USER': 'root',
#         'PASSWORD': '',
#         'HOST': 'localhost',  # Set this to the MySQL server host (e.g., 'localhost' or an IP)
#         'PORT': '3306',       # Set this to the MySQL server port (default is 3306)
#     }
# }
